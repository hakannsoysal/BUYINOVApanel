...
<!-- soldaki ayarlar butonu -->
<div id="mySidepanel" class="sidepanel">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
  <a href="account_settings.html">Hesap Ayarları</a>
  <a href="cikis.php">Çıkış</a>
</div>
<button class="openbtn" onclick="openNav()">&#9776; AYARLAR</button>
        ...
        <div class="inner-main">
            ...
            <div class="inner-main-header">
                ...
                <select class="custom-select custom-select-sm w-auto mr-1">
                    ...
                    <option value="3">Çözülmüş</option>
...
<!-- soldaki ayarlar kısmı buton css -->
<style type="text/css">
/* The sidepanel menu */
.sidepanel {
